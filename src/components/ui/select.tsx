...
function Select({
  ...
  // Root component doesn't accept className
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          // Add w-full to content for full width dropdown
